<div class="row">
    ...
    <div class="col-5">
      <div class="card">
          <!-- Shipping list -->
          <ul class="list-group list-group-flush" id="shipping-list">
              <!-- Shipping -->
          </ul>
      </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body" id="shipping-manage-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="shipping-title">
                </div>
                <div class="form-group">
                    <label for="shopping-description">Description</label>
                    <input type="text" class="form-control" id="shipping-description">
                </div>
                ...
                <div class="switches-container mt-2 mb-2">
                    <div class="d-flex align-items-center mr-3">
                        <label class="switch switch-label switch-primary">
                            <input class="switch-input" type="radio" name="shipping-price-type" data-action="price-type-handle" value="constant" checked>
                ...
                <div id="shipping-price-type-sections">
                    ...
                    <div id="constant-shipping-price-settings" class="mt-3 mb-3">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" aria-describedby="constant-shipping-price-label" id="shipping-price" value="1">
                        </div>
                    </div>
...
<div id="shipping-list-template" class="d-none">
    <li class="list-group-item flex-center-between">
        <label class="switch switch-label switch-primary">
            <input type="checkbox" class="switch-input" name="shipping[]" value="#ShippingID">
            <span class="switch-slider" data-checked="On" data-unchecked="Off"></span>
        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group mt-3 mb-3" id="condition-type-sections">
                        ...
                        <div class="input-group condition-type-section" id="condition-type-min-price-section">
                            ...
                            <input type="number" class="form-control" aria-describedby="condition-type-min-label" id="condition-min-price">
                        </div>
                        <!-- Max condition -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" aria-describedby="shipping-discount-label" id="shipping-discount">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="list-group list-group-flush position-relative" id="modal-countries-list">
                    <!-- Countries list -->
                </ul>
            </div>
            <div class="modal-footer">
